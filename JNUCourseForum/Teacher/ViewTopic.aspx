<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/TeacherMaster.master" AutoEventWireup="true" CodeFile="ViewTopic.aspx.cs" Inherits="Teacher_ViewTopic" %>
        ...
        <div class="topic-actions col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="buttons">
                <div class="reply-icon">
                    <a href="" title="Post a reply"><span></span>Post a reply</a>
                </div>
            </div>
...
<asp:Content ID="Content5" runat="server" ContentPlaceHolderID="holder1">
